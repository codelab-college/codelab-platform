      ...
      default:
        return (
          <div className="w-10 h-10 bg-gray-200 dark:bg-[#3e3e3e] rounded-full flex items-center justify-center">
            <span className="text-gray-600 dark:text-gray-400 font-bold">{rank}</span>
          </div>
        );
    }
  };
      ...
      <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-500 dark:text-gray-400">{contest?.title}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="p-2 bg-gray-100 dark:bg-[#3e3e3e] hover:bg-gray-200 dark:hover:bg-[#4e4e4e] rounded-lg transition-colors"
              >
        ...
        {leaderboard.length >= 3 && (
          <div className="grid grid-cols-3 gap-4 mb-6">
            {/* Second Place */}
            <div className="bg-white dark:bg-[#282828] border border-gray-200 dark:border-[#3e3e3e] rounded-xl p-6 text-center order-1">
              ...
              <div className="text-gray-900 dark:text-white font-semibold truncate">{leaderboard[1]?.username}</div>
            ...
            {/* First Place */}
            <div className="bg-gradient-to-b from-white dark:from-[#282828] to-gray-50 dark:to-[#1a1a1a] border border-[#ffa116]/50 rounded-xl p-6 text-center order-0 relative">
              ...
              <div className="text-gray-900 dark:text-white font-semibold text-lg truncate">{leaderboard[0]?.username}</div>
              <div className="text-[#ffa116] font-bold text-2xl mt-2">{leaderboard[0]?.total_score}</div>
              <div className="text-gray-500 text-sm">points</div>
            </div>

            {/* Third Place */}
            <div className="bg-white dark:bg-[#282828] border border-gray-200 dark:border-[#3e3e3e] rounded-xl p-6 text-center order-2">
              ...
              <div className="text-gray-900 dark:text-white font-semibold truncate">{leaderboard[2]?.username}</div>
                ...
                {leaderboard.length === 0 ? (
                  ...
                  leaderboard.map((entry, index) => (
                    <tr 
                      ...
                      className={`hover:bg-gray-50 dark:hover:bg-[#3e3e3e]/50 transition-colors ${
                        index < 3 ? 'bg-gray-50/50 dark:bg-[#1a1a1a]/50' : ''
                      }`}
                    >
                      ...
                      <td className="px-6 py-4 text-center">
                        <span className="text-gray-900 dark:text-white font-bold text-lg">{entry.total_score || 0}</span>
                      </td>
                      <td className="px-6 py-4 text-center">
                        <span className="text-gray-500 dark:text-gray-400">{entry.total_time || '-'}</span>
                      </td>
                    </tr>
                  ))
                )}
