      ...
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-[#ffa116]/20 to-[#ff6b00]/10 border border-[#ffa116]/30 rounded-xl p-6">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-2 bg-[#282828] rounded-lg px-4 py-2">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {/* Problems Solved */}
          <div className="bg-[#282828] border border-[#3e3e3e] rounded-xl p-5 hover:border-[#4a4a4a] transition-colors">
          ...
          <div className="bg-[#282828] border border-[#3e3e3e] rounded-xl p-5 hover:border-[#4a4a4a] transition-colors">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-sm text-gray-400 mb-1">Assignments</p>
                <p className="text-3xl font-bold text-white">
                ...
                {data?.activeAssignments?.length === 0 ? (
                  ...
                  data?.activeAssignments?.map((assignment) => (
                    <Link
                      ...
                      className="block p-4 hover:bg-[#3e3e3e]/50 transition-colors"
                    >
                      <div className="flex items-start justify-between">
              ...
              <div className="divide-y divide-[#3e3e3e]">
                {data?.upcomingContests?.length === 0 ? (
                  <div className="p-8 text-center">
                    ...
                    <p className="text-gray-400 text-sm">No upcoming contests</p>
                  </div>
                ) : (
        ...
        {/* Recent Submissions */}
        <div className="bg-[#282828] border border-[#3e3e3e] rounded-xl overflow-hidden">
          <div className="p-4 border-b border-[#3e3e3e] flex items-center gap-2">
                ...
                {data?.recentSubmissions?.length === 0 ? (
                  ...
                  data?.recentSubmissions?.map((submission) => (
                    <tr key={submission.id} className="hover:bg-[#3e3e3e]/50 transition-colors">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="text-sm text-gray-300">{submission.assignment_title}</span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
