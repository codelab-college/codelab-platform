      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-[#282828] border border-[#3e3e3e] rounded-xl p-4">
            ...
            <p className="font-medium text-white">{submission.problem_title}</p>
          </div>
          <div className="bg-[#282828] border border-[#3e3e3e] rounded-xl p-4">
            <p className="text-sm text-gray-400 mb-1">Assignment</p>
            <p className="font-medium text-white">{submission.assignment_title}</p>
          </div>
          <div className="bg-[#282828] border border-[#3e3e3e] rounded-xl p-4">
          ...
          <div className="bg-[#282828] border border-[#3e3e3e] rounded-xl p-4">
            ...
            <p className="font-medium text-white capitalize">{submission.language}</p>
          </div>
        </div>
        ...
        <div className="bg-[#282828] border border-[#3e3e3e] rounded-xl overflow-hidden">
          ...
          <pre className="bg-[#1a1a1a] text-gray-100 p-4 overflow-x-auto text-sm font-mono">
